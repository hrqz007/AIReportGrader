...
这些内容已经在 `.gitignore` 中做了基础排除，但手动上传压缩包时仍需自行检查。

---

## 申报与说明文档

项目 `docs/` 目录中包含用于申报、验收和材料撰写的技术说明文档：

| 文档 | 用途 |
|---|---|
| `00_系统事实摘要_供材料撰写.md` | 快速了解系统当前真实实现 |
| `01_系统架构与模块说明.md` | 系统架构和模块职责 |
| `02_数据库结构与核心数据流说明.md` | 数据库结构和数据流 |
| `03_AI能力、评分逻辑与教师复核机制说明.md` | AI 调用、评分和复核机制 |
| `04_系统业务流程与页面演示建议.md` | 视频和 PPT 演示建议 |
| `05_当前版本验收清单与已知问题.md` | 验收测试清单 |
| `06_系统截图清单建议.md` | 截图材料建议 |
| `07_对外申报表述风险校核.md` | 申报表述边界 |
